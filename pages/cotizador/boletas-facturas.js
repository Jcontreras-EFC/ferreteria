        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white rounded-lg shadow-md p-4 border border-green-200">
            <div className="flex items-center justify-between">
              ...
              <FiCreditCard className="text-green-400" size={24} />
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-4 border border-purple-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">{stats.facturas}</p>
              </div>
      ...
      {showDetailModal && selectedQuote && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-white rounded-lg max-w-4xl w-full my-8 shadow-2xl">
            <div className={`bg-gradient-to-r ${selectedQuote.documentType === 'factura' ? 'from-purple-600 to-purple-700' : 'from-green-600 to-green-700'} p-6 text-white rounded-t-lg`}>
              <div className="flex items-center justify-between">
                <div>
